---
name: hora-forge
description: Zero Untested Delivery workflow. Chaque livrable est prouve fonctionnel avant de sortir. USE WHEN forge, hora forge, implement feature, build, develop, dev, nouvelle feature, fix bug, TDD, test-driven.
---
...
Inspire de : NASA Cleanroom (zero defaut), Power of Ten (Holzmann/JPL), Toyota Jidoka (stop on red), TDD (Kent Beck), DO-178C (tracabilite), Google Testing Pyramid, Design by Contract (Meyer).
